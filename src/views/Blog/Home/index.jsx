...
function Home(props) {
    ...
    return (<div style={{display: 'flex'}}>
        <div className="ArticleList"> {
            Data.map((Item)=>{
                return (<div className="ArticleList_Item"
                        key={Item.id}>
                        ...
                        <span>< IconFont type="icon-taiyang" className="ArticleList_Item__Icon" / >
                            </span>
                            <span className="ArticleList_Item__Date"> {moment(Item.createdTime).add(10, 'days').calendar()} < /span>

                        { /* 分类 */} <span>< IconFont type="icon-duihaoqipao2" className="ArticleList_Item__Icon" / >
                                </span> {
                        ...
                        { /* 标签 */} <span>< IconFont type="icon-biaoqian" className="ArticleList_Item__Icon" / >
                                            </span>{
                                             ...
                                             继续阅读</span> </div> { /*<hr className="ArticleList_Item__divider" />*/}
                                                        <
                                                            /div> <
